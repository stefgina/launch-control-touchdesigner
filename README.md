...
- Avoid buying new rebranded crappy midi IC's for irrational amounts of $$
```
...
If you like the concept, you can contribute to this repo on the following matters (or brainstorm new ones) :
